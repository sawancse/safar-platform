    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/sale-properties/**").permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/v1/sale-properties/admin/reindex").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/v1/builder-projects/**").permitAll()
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/locality-trends/**").permitAll()
