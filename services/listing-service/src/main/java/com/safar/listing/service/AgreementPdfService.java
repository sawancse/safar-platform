...
public class AgreementPdfService {
    ...
    private String renderHtml(AgreementRequest a, List<AgreementParty> parties) {
        ...
        return """
                ...
                <body>
                    ...
                    <div class="footer">
                        Generated by BhramanKaro &#8226; This is an unsigned draft for review only and does not constitute a legally executed agreement.
                    </div>
                </body>
                </html>
                """.formatted(
    ...
    private static final String SALE_TEMPLATE = """
            ...
            <div class="footer center" style="margin-top:30px; font-size:9px; color:#888;">
              Generated by BhramanKaro &#8226; This is an unsigned draft Agreement for Sale based on the RERA model form, for review only; it does not constitute a legally executed agreement and should be finalised with legal advice before registration.
            </div>
            </body></html>
            """;
}
