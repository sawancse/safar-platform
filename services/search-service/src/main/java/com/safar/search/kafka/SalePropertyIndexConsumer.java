...
public class SalePropertyIndexConsumer {
    ...
    private SalePropertyDocument mapToDocument(Map<String, Object> p) {
        ...
        return SalePropertyDocument.builder()
                ...
                // Land/agriculture/legal fields
                .totalAcres(toDouble(p.get("totalAcres")))
                .roadAccess(str(p.get("roadAccess")))
                .zoneType(str(p.get("zoneType")))
                .boundaryWall(toBool(p.get("boundaryWall")))
                .irrigationType(str(p.get("irrigationType")))
                .soilType(str(p.get("soilType")))
                .organicCertified(toBool(p.get("organicCertified")))
                .ownershipType(str(p.get("ownershipType")))
                .titleClear(toBool(p.get("titleClear")))
                .reraNumber(str(p.get("reraNumber")))
                .agentName(str(p.get("agentName")))
                // Status
