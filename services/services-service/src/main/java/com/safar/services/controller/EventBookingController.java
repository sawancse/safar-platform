...
import com.safar.services.service.EventBookingStaffService;
import com.safar.services.service.EventBookingVendorService;
...
public class EventBookingController {
    ...
    @GetMapping("/{id}/staff")
    public ResponseEntity<List<com.safar.services.dto.EventStaffAssignmentResponse>> listStaff(@PathVariable UUID id) {
