    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/v1/chef-events/*/location").authenticated()
                        .requestMatchers(HttpMethod.POST, "/api/v1/chef-events/*/start-job-as-vendor").authenticated()
                        .requestMatchers(HttpMethod.POST, "/api/v1/chef-events/*/complete-as-vendor").authenticated()
